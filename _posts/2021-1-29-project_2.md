...
for x in new_df.yearmonth.unique():
  df_month = new_df[new_df.yearmonth == x]
  max_date = df_month.InvoiceDate.max()
  min_date = df_month.InvoiceDate.min()
  list_max_date.append([x, min_date, max_date])

list_max_date
```
[[201012, Timestamp('2010-12-01 08:26:00'), Timestamp('2010-12-23 16:06:00')],
 [201101, Timestamp('2011-01-04 10:00:00'), Timestamp('2011-01-31 16:59:00')],
 [201102, Timestamp('2011-02-01 08:23:00'), Timestamp('2011-02-28 17:01:00')],
 [201103, Timestamp('2011-03-01 08:30:00'), Timestamp('2011-03-31 19:55:00')],
 [201104, Timestamp('2011-04-01 08:22:00'), Timestamp('2011-04-28 19:53:00')],
 [201105, Timestamp('2011-05-01 10:51:00'), Timestamp('2011-05-31 15:41:00')],
 [201106, Timestamp('2011-06-01 07:37:00'), Timestamp('2011-06-30 20:08:00')],
 [201107, Timestamp('2011-07-01 08:16:00'), Timestamp('2011-07-31 16:04:00')],
 [201108, Timestamp('2011-08-01 08:30:00'), Timestamp('2011-08-31 17:16:00')],
 [201109, Timestamp('2011-09-01 08:25:00'), Timestamp('2011-09-30 15:52:00')],
 [201110, Timestamp('2011-10-02 10:32:00'), Timestamp('2011-10-31 17:13:00')],
 [201111, Timestamp('2011-11-01 08:16:00'), Timestamp('2011-11-30 17:37:00')],
 [201112, Timestamp('2011-12-01 08:33:00'), Timestamp('2011-12-09 12:50:00')]]

data on December 2011 showing drop sharply because we only have data until 09 December which is different from another month.
