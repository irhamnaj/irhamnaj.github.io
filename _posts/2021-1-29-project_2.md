...
The visualiation above show that the data is not follow normal asumtion. So to solve that problem, I will log transform all three columns. After that, rescale using a scaler to make every data in all columns has the same range.
